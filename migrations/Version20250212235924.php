 ...
 */
final class Version20250212235924 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE grp (code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, start_token TEXT DEFAULT NULL, count INT DEFAULT NULL, extract_count INT NOT NULL, marking VARCHAR(32) DEFAULT NULL, PRIMARY KEY(code))');
        ...
        $this->addSql('ALTER TABLE extract ADD CONSTRAINT FK_3E5A31DED51E9150 FOREIGN KEY (grp_id) REFERENCES grp (code) NOT DEFERRABLE INITIALLY IMMEDIATE');
